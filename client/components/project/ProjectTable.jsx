...
import { FaEye, FaEdit, FaTrash, FaHospital, FaUserPlus } from "react-icons/fa";

export default function ProjectTable({ projects = [], onRefresh }) {
  ...
  if (projects.length === 0) {
    return (
      <div className="bg-white rounded-3xl shadow-xl p-10 text-center">
        <h2 className="text-2xl font-bold text-gray-600">No Projects Found</h2>
        ...
        <table className="w-full">
          <thead className="bg-pink-50">
            <tr>
              ...
              <th className="text-left px-6 py-4">Mentor</th>

              <th className="text-center px-6 py-4">Patients</th>

              <th className="text-center px-6 py-4">Start Date</th>
          ...
          <tbody>
            {projects.map((project) => (
              ...
              >
                ...
                <td className="px-6 py-5">{project.hospitalName || "-"}</td>

                {/* Mentor */}

                <td className="px-6 py-5">{project.mentor}</td>
